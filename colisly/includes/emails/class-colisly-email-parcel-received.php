...
class COLISLY_Email_Parcel_Received extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Parcel received (Colisly Parcel Forwarding)', 'colisly' );
		$this->description    = __( 'Sent to the client when one of their parcels is registered at the warehouse.', 'colisly' );
	...
	public function get_default_subject() {
		return __( '[{site_title}] Your parcel {parcel_reference} has been received', 'colisly' );
	}
	...
	public function get_default_heading() {
		return __( 'Parcel {parcel_reference} received', 'colisly' );
	}
