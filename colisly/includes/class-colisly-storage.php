...
class COLISLY_Storage {
	...
	public static function billable_days( $parcel ) {
		$free_days = (int) COLISLY_Settings::get( 'free_storage_days', 15 );
	...
	public static function fees_for_parcel( $parcel ) {
		$per_day = (float) COLISLY_Settings::get( 'storage_fee_per_day', 0 );
		 ...
		 * @param object $parcel Parcel row.
		 */
		return (float) apply_filters( 'colisly_parcel_storage_fees', round( $fees, 2 ), $parcel );
	}
