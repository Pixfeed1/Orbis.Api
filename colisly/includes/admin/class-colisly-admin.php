...
class COLISLY_Admin {
	...
	public static function register_menu() {
		add_menu_page(
			__( 'Colisly Parcel Forwarding', 'colisly' ),
			__( 'Colisly', 'colisly' ),
			'colisly_manage',
			'colisly-clients',
	...
	public static function enqueue_assets( $hook ) {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'    => array(
					'noResults'   => __( 'No clients found.', 'colisly' ),
					'inStock'     => __( 'parcel(s) in stock', 'colisly' ),
					'yes'         => __( 'Yes', 'colisly' ),
					'no'          => __( 'No', 'colisly' ),
					'refCol'      => __( 'Parcel number', 'colisly' ),
					'weightCol'   => __( 'Weight (kg)', 'colisly' ),
