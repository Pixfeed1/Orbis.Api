...
<p>
	...
	printf(
		...
		esc_html__( 'Shipment request %1$s has just been created by client %2$s (%3$s).', 'colisly' ),
...
<table cellspacing="0" cellpadding="6" border="1" style="width: 100%; border: 1px solid #e5e5e5; border-collapse: collapse;">
	...
	<tr>
		<th scope="row" style="text-align: left;"><?php esc_html_e( 'Total weight', 'colisly' ); ?></th>
		<td><?php echo esc_html( number_format_i18n( (float) $shipment->total_weight, 3 ) ); ?> kg</td>
	</tr>
	<tr>
		<th scope="row" style="text-align: left;"><?php esc_html_e( 'Total (parcels + storage + transport)', 'colisly' ); ?></th>
...
?>
<p>
	<a href="<?php echo esc_url( $colisly_client_url ); ?>"><?php esc_html_e( 'Open the client record', 'colisly' ); ?></a>
</p>
