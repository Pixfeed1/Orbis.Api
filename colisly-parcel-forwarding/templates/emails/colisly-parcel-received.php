...
<p><?php esc_html_e( 'Hello,', 'colisly-parcel-forwarding' ); ?></p>

<p>
	<?php
	printf(
		/* translators: %s: parcel reference. */
		esc_html__( 'We have received your parcel %s at the warehouse. It is now visible in your account, under “My parcels”.', 'colisly-parcel-forwarding' ),
...
<table cellspacing="0" cellpadding="6" border="1" style="width: 100%; border: 1px solid #e5e5e5; border-collapse: collapse;">
	<tr>
		<th scope="row" style="text-align: left;"><?php esc_html_e( 'Parcel number', 'colisly-parcel-forwarding' ); ?></th>
		<td><?php echo esc_html( $parcel->reference ); ?></td>
	</tr>
	<tr>
		<th scope="row" style="text-align: left;"><?php esc_html_e( 'Tracking number', 'colisly-parcel-forwarding' ); ?></th>
		<td><?php echo esc_html( $parcel->tracking_number ? $parcel->tracking_number : '—' ); ?></td>
	</tr>
	<tr>
		<th scope="row" style="text-align: left;"><?php esc_html_e( 'Weight', 'colisly-parcel-forwarding' ); ?></th>
		<td><?php echo esc_html( number_format_i18n( (float) $parcel->weight, 3 ) ); ?> kg</td>
	</tr>
	<tr>
		<th scope="row" style="text-align: left;"><?php esc_html_e( 'Free storage', 'colisly-parcel-forwarding' ); ?></th>
		<td>
			<?php
			printf(
				/* translators: %d: number of free storage days. */
				esc_html( _n( '%d day', '%d days', (int) COLISLY_Settings::get( 'free_storage_days', 15 ), 'colisly-parcel-forwarding' ) ),
