...
class COLISLY_Email_Shipment_Requested extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = __( 'Shipment requested (Colisly Parcel Forwarding)', 'colisly-parcel-forwarding' );
		$this->description    = __( 'Sent to the staff when a client creates a shipment request.', 'colisly-parcel-forwarding' );
	...
	public function init_form_fields() {
		...
		$this->form_fields['recipient'] = array(
			'title'       => __( 'Recipient(s)', 'colisly-parcel-forwarding' ),
			'type'        => 'text',
			/* translators: %s: WP admin email. */
			'description' => sprintf( __( 'Comma-separated addresses. Defaults to %s.', 'colisly-parcel-forwarding' ), '<code>' . esc_html( get_option( 'admin_email' ) ) . '</code>' ),
			'placeholder' => '',
			'default'     => '',
			'desc_tip'    => true,
		);
	...
	public function get_default_subject() {
		return __( '[{site_title}] New shipment request {shipment_reference} (client {client_reference})', 'colisly-parcel-forwarding' );
	}
	...
	public function get_default_heading() {
		return __( 'New shipment request {shipment_reference}', 'colisly-parcel-forwarding' );
	}
