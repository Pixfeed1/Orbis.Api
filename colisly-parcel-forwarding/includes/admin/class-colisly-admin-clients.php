...
class COLISLY_Admin_Clients {
	...
	private static function render_list() {
		...
		<div class="wrap colisly-wrap">
			<h1 class="wp-heading-inline"><?php esc_html_e( 'Clients', 'colisly-parcel-forwarding' ); ?></h1>
			...
			<form method="get" class="colisly-search-form">
				...
				<p class="search-box">
					<label class="screen-reader-text" for="colisly-client-search"><?php esc_html_e( 'Search clients', 'colisly-parcel-forwarding' ); ?></label>
					<input type="search" id="colisly-client-search" name="s" value="<?php echo esc_attr( $term ); ?>" placeholder="<?php esc_attr_e( 'Reference, name, e-mail, phone…', 'colisly-parcel-forwarding' ); ?>" />
					<button type="submit" class="button"><?php esc_html_e( 'Search', 'colisly-parcel-forwarding' ); ?></button>
				</p>
			</form>

			<h2><?php esc_html_e( 'Add a client', 'colisly-parcel-forwarding' ); ?></h2>
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="colisly-inline-form">
				...
				<label for="colisly-new-client-user"><?php esc_html_e( 'WordPress user', 'colisly-parcel-forwarding' ); ?></label>
				<?php
				wp_dropdown_users(
					array(
						'name'             => 'user_id',
						...
						'number'           => 200,
						'show_option_none' => __( '— Select —', 'colisly-parcel-forwarding' ),
					)
				);
				?>
				<button type="submit" class="button button-primary"><?php esc_html_e( 'Create the client record', 'colisly-parcel-forwarding' ); ?></button>
			</form>
			...
			<table class="wp-list-table widefat fixed striped">
				<thead>
					<tr>
						...
						<th><?php esc_html_e( 'E-mail', 'colisly-parcel-forwarding' ); ?></th>
						<th><?php esc_html_e( 'Phone', 'colisly-parcel-forwarding' ); ?></th>
						<th><?php esc_html_e( 'Parcels in stock', 'colisly-parcel-forwarding' ); ?></th>
						<th><?php esc_html_e( 'Created on', 'colisly-parcel-forwarding' ); ?></th>
					</tr>
				</thead>
				<tbody>
					<?php if ( empty( $clients ) ) : ?>
						<tr><td colspan="6"><?php esc_html_e( 'No clients found.', 'colisly-parcel-forwarding' ); ?></td></tr>
					<?php else : ?>
	...
	private static function render_single( $client_id ) {
		...
		if ( ! $client ) {
			echo '<div class="wrap"><p>' . esc_html__( 'Client not found.', 'colisly-parcel-forwarding' ) . '</p></div>';
			return;
		}
		...
		<div class="wrap colisly-wrap">
			<h1 class="wp-heading-inline">
				...
				printf(
					...
					esc_html__( 'Client record %1$s — %2$s', 'colisly-parcel-forwarding' ),
					esc_html( $client->reference ),
					esc_html( $user ? $user->display_name : '' )
				);
				?>
			</h1>
			<a href="<?php echo esc_url( $new_parcel_url ); ?>" class="page-title-action"><?php esc_html_e( 'New parcel', 'colisly-parcel-forwarding' ); ?></a>
			<hr class="wp-header-end" />
			<?php COLISLY_Admin::maybe_notice(); ?>
			...
			<div class="colisly-indicators">
				<div class="colisly-indicator">
					...
					<span class="colisly-indicator-label"><?php esc_html_e( 'Parcels in stock', 'colisly-parcel-forwarding' ); ?></span>
				</div>
				<div class="colisly-indicator">
					<span class="colisly-indicator-value"><?php echo esc_html( number_format_i18n( $indicators['weight_in_stock'], 3 ) ); ?> kg</span>
					<span class="colisly-indicator-label"><?php esc_html_e( 'Total stored weight', 'colisly-parcel-forwarding' ); ?></span>
				</div>
				<div class="colisly-indicator">
					<span class="colisly-indicator-value"><?php echo esc_html( number_format_i18n( $indicators['shipments_count'] ) ); ?></span>
					<span class="colisly-indicator-label"><?php esc_html_e( 'Shipments done', 'colisly-parcel-forwarding' ); ?></span>
				</div>
				<div class="colisly-indicator">
					<span class="colisly-indicator-value"><?php echo esc_html( COLISLY_Format::price( $indicators['storage_fees_due'] ) ); ?></span>
					<span class="colisly-indicator-label"><?php esc_html_e( 'Storage fees due', 'colisly-parcel-forwarding' ); ?></span>
				</div>
				<div class="colisly-indicator">
					...
					<span class="colisly-indicator-label"><?php esc_html_e( 'Last reception', 'colisly-parcel-forwarding' ); ?></span>
				</div>
				<div class="colisly-indicator">
					...
					<span class="colisly-indicator-label"><?php esc_html_e( 'Last shipment', 'colisly-parcel-forwarding' ); ?></span>
				</div>
			</div>

			<h2 class="nav-tab-wrapper colisly-tabs">
				<a href="#colisly-tab-infos" class="nav-tab nav-tab-active"><?php esc_html_e( 'Information', 'colisly-parcel-forwarding' ); ?></a>
				<a href="#colisly-tab-stock" class="nav-tab"><?php esc_html_e( 'Parcels in stock', 'colisly-parcel-forwarding' ); ?></a>
				<a href="#colisly-tab-shipped" class="nav-tab"><?php esc_html_e( 'Shipped parcels', 'colisly-parcel-forwarding' ); ?></a>
				<a href="#colisly-tab-shipments" class="nav-tab"><?php esc_html_e( 'Shipments', 'colisly-parcel-forwarding' ); ?></a>
				<a href="#colisly-tab-documents" class="nav-tab"><?php esc_html_e( 'Documents', 'colisly-parcel-forwarding' ); ?></a>
				<a href="#colisly-tab-history" class="nav-tab"><?php esc_html_e( 'History', 'colisly-parcel-forwarding' ); ?></a>
			</h2>
			...
			<div id="colisly-tab-infos" class="colisly-tab-panel colisly-tab-active">
				<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
					...
					<table class="form-table" role="presentation">
						<tr>
							<th scope="row"><?php esc_html_e( 'Client reference', 'colisly-parcel-forwarding' ); ?></th>
							<td><code><?php echo esc_html( $client->reference ); ?></code></td>
						</tr>
						<tr>
							<th scope="row"><?php esc_html_e( 'User', 'colisly-parcel-forwarding' ); ?></th>
							<td>
								<?php if ( $user ) : ?>
						...
						<tr>
							<th scope="row"><label for="colisly-phone"><?php esc_html_e( 'Phone', 'colisly-parcel-forwarding' ); ?></label></th>
							<td><input type="text" class="regular-text" id="colisly-phone" name="phone" value="<?php echo esc_attr( $client->phone ); ?>" /></td>
						</tr>
						<tr>
							<th scope="row"><label for="colisly-admin-notes"><?php esc_html_e( 'Internal notes (never visible to the client)', 'colisly-parcel-forwarding' ); ?></label></th>
					...
					<?php submit_button( __( 'Save', 'colisly-parcel-forwarding' ) ); ?>
				</form>
			</div>
			...
			<div id="colisly-tab-documents" class="colisly-tab-panel">
				...
				<h3><?php esc_html_e( 'Add a document', 'colisly-parcel-forwarding' ); ?></h3>
				<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data" class="colisly-inline-form">
					...
					<label>
						...
						<?php esc_html_e( 'Visible to the client', 'colisly-parcel-forwarding' ); ?>
					</label>
					<button type="submit" class="button"><?php esc_html_e( 'Add', 'colisly-parcel-forwarding' ); ?></button>
				</form>
			</div>
	...
	private static function parcels_table( $parcels, $with_action ) {
		...
		<table class="wp-list-table widefat fixed striped">
			<thead>
				<tr>
					<th><?php esc_html_e( 'Number', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Received on', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Tracking', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Weight (kg)', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Price', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Grouping', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Storage fees', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Internal comment', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Photo', 'colisly-parcel-forwarding' ); ?></th>
					<?php if ( $with_action ) : ?>
			...
			<tbody>
				<?php if ( empty( $parcels ) ) : ?>
					<tr><td colspan="10"><?php esc_html_e( 'No parcels.', 'colisly-parcel-forwarding' ); ?></td></tr>
				<?php else : ?>
					<?php foreach ( $parcels as $parcel ) : ?>
						<tr>
							...
							<td><?php echo $parcel->allow_grouping ? esc_html__( 'Yes', 'colisly-parcel-forwarding' ) : esc_html__( 'No', 'colisly-parcel-forwarding' ); ?></td>
							...
							<td>
								<?php if ( ! empty( $parcel->photo_path ) ) : ?>
									<a href="<?php echo esc_url( COLISLY_Downloads::photo_url( $parcel ) ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'View', 'colisly-parcel-forwarding' ); ?></a>
								<?php else : ?>
									—
								<?php endif; ?>
							</td>
	...
	public static function parcel_status_form( $parcel ) {
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="colisly-status-form">
			...
			<label class="screen-reader-text" for="colisly-status-<?php echo esc_attr( (string) $parcel->id ); ?>"><?php esc_html_e( 'Status', 'colisly-parcel-forwarding' ); ?></label>
			...
			<button type="submit" class="button button-small"><?php esc_html_e( 'OK', 'colisly-parcel-forwarding' ); ?></button>
		</form>
		<?php
	}
		...
		<table class="wp-list-table widefat fixed striped">
			<thead>
				<tr>
					...
					<th><?php esc_html_e( 'Order', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Status', 'colisly-parcel-forwarding' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php if ( empty( $shipments ) ) : ?>
					<tr><td colspan="8"><?php esc_html_e( 'No shipments.', 'colisly-parcel-forwarding' ); ?></td></tr>
				<?php else : ?>
						...
						<tr>
								...
								<?php if ( $order ) : ?>
									<a href="<?php echo esc_url( $order->get_edit_order_url() ); ?>">
										...
										printf(
											...
											esc_html__( '#%s', 'colisly-parcel-forwarding' ),
							...
							<td>
								<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="colisly-status-form">
									...
									<label class="screen-reader-text" for="colisly-ship-status-<?php echo esc_attr( (string) $shipment->id ); ?>"><?php esc_html_e( 'Status', 'colisly-parcel-forwarding' ); ?></label>
	...
	private static function documents_table( $documents ) {
		...
		<table class="wp-list-table widefat fixed striped">
			<thead>
				<tr>
					<th><?php esc_html_e( 'Title', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Added on', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Visibility', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'File', 'colisly-parcel-forwarding' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php if ( empty( $documents ) ) : ?>
					<tr><td colspan="4"><?php esc_html_e( 'No documents.', 'colisly-parcel-forwarding' ); ?></td></tr>
				<?php else : ?>
					<?php foreach ( $documents as $document ) : ?>
						<tr>
							<td><?php echo esc_html( $document->title ); ?></td>
							<td><?php echo esc_html( COLISLY_Format::date( $document->created_at ) ); ?></td>
							<td><?php echo 'admin' === $document->visibility ? esc_html__( 'Internal', 'colisly-parcel-forwarding' ) : esc_html__( 'Client', 'colisly-parcel-forwarding' ); ?></td>
							<td>
								<?php if ( ! empty( $document->file_path ) ) : ?>
									<a href="<?php echo esc_url( COLISLY_Downloads::document_url( $document ) ); ?>"><?php esc_html_e( 'Download', 'colisly-parcel-forwarding' ); ?></a>
								<?php else : ?>
									—
								<?php endif; ?>
							</td>
	...
	private static function history_table( $entries ) {
		...
		<table class="wp-list-table widefat fixed striped">
			<thead>
				<tr>
					<th><?php esc_html_e( 'Date', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Event', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'Details', 'colisly-parcel-forwarding' ); ?></th>
					<th><?php esc_html_e( 'By', 'colisly-parcel-forwarding' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php if ( empty( $entries ) ) : ?>
					<tr><td colspan="4"><?php esc_html_e( 'No operations recorded.', 'colisly-parcel-forwarding' ); ?></td></tr>
				<?php else : ?>
	...
	public static function handle_create() {
		...
		COLISLY_Admin::redirect( 'colisly-clients', array( 'client' => (int) $result ), __( 'Client record created.', 'colisly-parcel-forwarding' ) );
	}
	...
	public static function handle_update() {
		...
		COLISLY_Admin::redirect( 'colisly-clients', array( 'client' => $client_id ), __( 'Client record updated.', 'colisly-parcel-forwarding' ) );
	}
	...
	public static function handle_add_document() {
		...
		COLISLY_Admin::redirect( 'colisly-clients', array( 'client' => $client_id ), __( 'Document added.', 'colisly-parcel-forwarding' ) );
	}
	...
	public static function handle_set_shipment_status() {
		...
		COLISLY_Admin::redirect( 'colisly-clients', array( 'client' => $client_id ), __( 'Shipment status updated.', 'colisly-parcel-forwarding' ) );
	}
