    ...
    <div class="pf-nav-links">
      ...
      <div class="pf-nav-item pf-has-sub">
        ...
        <div class="pf-sub" role="menu">
          <a href="<?php echo esc_url( home_url( '/accompagnement-seo/' ) ); ?>" role="menuitem">Accompagnement SEO</a>
          <a href="<?php echo esc_url( home_url( '/seo-local/' ) ); ?>" role="menuitem">SEO local</a>
          <a href="<?php echo esc_url( home_url( '/colisly-extension-woocommerce-de-reexpedition-de-colis/' ) ); ?>" role="menuitem">Colisly, réexpédition de colis</a>
        </div>
      </div>
...
<div class="pf-mobile-overlay" id="pfMobileOverlay">
  ...
  <div class="pf-mobile-overlay-links">
    ...
    <a href="<?php echo esc_url( home_url( '/accompagnement-seo/' ) ); ?>" class="pf-mobile-sub" onclick="pfToggleMenu()">Accompagnement SEO</a>
    <a href="<?php echo esc_url( home_url( '/seo-local/' ) ); ?>" class="pf-mobile-sub" onclick="pfToggleMenu()">SEO local</a>
